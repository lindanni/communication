...
<html>
    ...
    <body>
	   <p class="biaoti">试题上传<p>
	   
	    <form id="form2" name="form2" action="testServlet" method="post" enctype="multipart/form-data">
	   
	   <table align="center" width="500" border="0" cellpadding="0" cellspacing="0" class="biao">	
	              <tr>
					<td class="biaotou">试题：</td>
					<td class="neirong" colspan="2">
					   
					   
						<a href="javascript:;" class="file">
						    <input type="file" id="file" name="file">点击这里上传试题
						</a>
